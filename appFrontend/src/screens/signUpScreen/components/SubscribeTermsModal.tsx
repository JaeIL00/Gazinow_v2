    ...
    <Modal visible onRequestClose={!!openUrl ? () => setOpenUrl('') : closeModal} transparent>
      {!!openUrl ? (
        <SafeAreaView className="flex-1">
          <View className="pl-16 pt-13 pb-10 bg-white border-b-1 border-gray-ddd">
        ...
        <>
          ...
          <View className="flex-1 bg-[#00000099] justify-end">
            ...
            >
              <Pressable
                hitSlop={10}
                className="flex-row items-center mb-15 py-13 pl-10 bg-gray-9f9 rounded-5"
                onPress={allChangeAgreeTerms}
              >
                <View className="bg-gray-3e3 rounded-3 w-22 h-22 mr-10 items-center justify-center">
                ...
                {listData.map((text) => (
                  ...
                  >
                    <View className="flex-row items-center">
                      <View className="rounded-3 bg-gray-3e3 w-22 h-22 mr-10 items-center justify-center">
